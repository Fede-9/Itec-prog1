...
# En una primera etapa, NO trabajaremos las fechas, solamente si está o no ocupada el día en curso.
...
# Para la segunda etapa conversaremos las diferentes opciones para el manejo de fechas.
