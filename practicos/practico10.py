...
# Deben decidir que categorías utilizar (ej: trabajo, estudio, personal, etc.), el manejo
# del tiempo (fechas, urgencias, límites temporales, etc.)
...
# Es obligatorio implementar el práctico con la estructura trabajada en la clase del 3 de agosto (ver comentarios en las Novedades)
